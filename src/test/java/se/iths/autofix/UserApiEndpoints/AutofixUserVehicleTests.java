...
class AutofixUserVehicleTests {
    ...
    @Test
    void userTrytoAccessVehicleIdReturnOk() throws Exception{
    ...
    @Test
    void userTrytoDeleteVehicleIdReturnOk() throws Exception{
    ...
    @Test
    void userTrytoCreateVehicleIdReturnOk() throws Exception{
